...
Suite of codes codes for a teaching-and-learning project studying waves in a flume.  The USP of the project is the very nice use of **Lego** to create a piston wavemaker.  The codes span the range from data analysis, mathematical modelling, to CFD simulations with OpenFOAM.
